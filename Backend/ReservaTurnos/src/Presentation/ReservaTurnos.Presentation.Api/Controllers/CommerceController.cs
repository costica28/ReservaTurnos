...
namespace ReservaTurnos.Presentation.Api.Controllers
{
    ...
    public class CommerceController : ControllerBase
    {
        ...
        public CommerceController(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        /// <summary>
        /// Obtiene toda la información de los comercios que existen hasta la fecha
        /// </summary>
        /// <returns></returns>
        [HttpGet]
        [Authorize]
        ...
        {
            return Ok(new { data = await _unitOfWork.Repository<Commerce>().GetAllAsync() });
        }
    }
}
